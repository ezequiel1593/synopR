...
present_weather <- c(
  ...
  "20" = "Drizzle (not freezing) or snow grains not falling as shower(s), during the preceding hour",
  "21" = "Rain (not freezing) not falling as shower(s), during the preceding hour",
  "22" = "Snow not falling as shower(s), during the preceding hour",
  "23" = "Rain and snow or ice pellets not falling as shower(s), during the preceding hour",
  "24" = "Freezing drizzle or freezing rain not falling as shower(s), during the preceding hour",
  "25" = "Shower(s) of rain, during the preceding hour",
  "26" = "Shower(s) of snow, or of rain and snow, during the preceding hour",
  "27" = "Shower(s) of hail, or of rain and hail, during the preceding hour",
  "28" = "Fog or ice fog, during the preceding hour",
  "29" = "Thunderstorm (with or without precipitation), during the preceding hour",
